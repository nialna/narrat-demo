...
function getCharacterInfo(character) {
    return config$1.characters[character];
}
function getCharacterPictureUrl(character, pose) {
    ...
    if (info.sprites) {
        return `${config$1.config.imagesPath}${info.sprites[pose]}`;
    }
}
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock("div", {
    class: "dialog-box w-full",
    style: _ctx.dialogBoxStyle
  }, [
    createVNode("div", _hoisted_1, [
      (_ctx.options.title)
        ? (openBlock(), createBlock("span", {
          ...
          }, toDisplayString(_ctx.options.title), 5))
        : createCommentVNode("", true),
      createVNode("span", {
        class: "dialog-text dialog-separator",
      ...
      createVNode("span", {
        class: "dialog-text",
        style: _ctx.textStyle
      }, toDisplayString(_ctx.options.text), 5),
      (_ctx.canInteract && _ctx.choices)
        ? (openBlock(), createBlock("div", _hoisted_2, [
            (openBlock(true), createBlock(Fragment, null, renderList(_ctx.choices, (choice, index) => {
              return (openBlock(), createBlock("p", {
                key: index,
                style: _ctx.dialogStyle(choice),
                onClick: $event => (_ctx.chooseOption(choice)),
                class: "dialog-choice"
              }, toDisplayString(index + 1) + ". –  " + toDisplayString(choice.choice), 13, ["onClick"]))
            }), 128))
          ]))
        : (_ctx.canInteract)
          ? (openBlock(), createBlock("div", _hoisted_3, [
              createVNode("div", {
                onClick: _cache[1] || (_cache[1] = $event => (_ctx.chooseOption(0))),
...
const _hoisted_1$1 = { class: "dialog-picture" };
...
const _hoisted_5 = /*#__PURE__*/createTextVNode(" default header ");
const _hoisted_6 = { class: "modal-body" };
const _hoisted_7 = /*#__PURE__*/createTextVNode(" default body ");
...
const _hoisted_2$2 = /*#__PURE__*/createVNode("h3", null, "Debug Menu!", -1);
const _hoisted_3$2 = /*#__PURE__*/createTextVNode(" Hello this is the debug menu. ");
const _hoisted_4$1 = /*#__PURE__*/createVNode("option", {
  selected: "",
  disabled: ""
}, "Jump to a label", -1);
    ...
    (_ctx.showDebug)
      ? (openBlock(), createBlock(_component_modal, {
          ...
          body: withCtx(() => [
            ...
            createVNode("select", {
              name: "label-selector",
              onChange: _cache[2] || (_cache[2] = $event => (_ctx.labelSelected($event)))
            }, [
              _hoisted_4$1,
              (openBlock(true), createBlock(Fragment, null, renderList(_ctx.labels, (label) => {
...
const _hoisted_3$3 = { class: "dialog-container" };
const _hoisted_4$2 = {
  key: 1,
  class: "flex flex-col"
};
      ...
      ? (openBlock(), createBlock("div", _hoisted_2$3, [
          ...
          createVNode("div", _hoisted_3$3, [
            createVNode(TransitionGroup, {
              ...
              default: withCtx(() => [
                (openBlock(true), createBlock(Fragment, null, renderList(_ctx.dialog, (dialog, i) => {
        ...
        ? (openBlock(), createBlock("div", _hoisted_4$2, [
            ...
            (_ctx.saveFile)
              ? (openBlock(), createBlock("button", {
                  key: 0,
                  class: "button",
                  onClick: _cache[2] || (_cache[2] = (...args) => (_ctx.loadGame && _ctx.loadGame(...args)))
                }, "Continue Game"))
              : createCommentVNode("", true)
          ]))
        : (openBlock(), createBlock("div", _hoisted_5$1, [
            createVNode("p", null, "Loading... " + toDisplayString(_ctx.config.charactersPath), 1)
          ])),
    createVNode(_component_DebugMenu)
  ]))
}
...
const INDENT_SIZE = 4;
function parseRenpyScript(code, ctx) {
...
function processRenpyCommands(ctx, lines) {
    let currentLine = 0;
    const branch = [];
    while (currentLine < lines.length) {
        ...
        switch (operator) {
            ...
            case 'choice':
                ...
                const prompts = choices.map((choice, index) => parseChoiceOption(ctx, choice, index));
                command.options = {
...
function startApp(config, options) {
    console.log('%c Narrat game engine – 0.0.13 - January 31, 2021 14:52:25', 'background: #222; color: #bada55');
    const app = createApp(script$4, {
        config,
    });
    app.mount('#app');
    const { store, key } = setupStore();
    app.use(store, key);
