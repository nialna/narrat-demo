...
// Version: 0.2.12 - July 11, 2021 16:24:29
...
const _hoisted_5$1 = { class: "grid grid-cols-3 gap-4" };
      ...
      ? (openBlock(), createBlock(_component_modal, {
          ...
          body: withCtx(() => [
            ...
            createVNode("div", _hoisted_5$1, [
              createVNode("button", {
                onClick: _cache[3] || (_cache[3] = (...args) => (_ctx.wordCount && _ctx.wordCount(...args)))
              }, "Word Count"),
              createVNode("button", {
...
var howler = createCommonjsModule$1(function (module, exports) {
/*!
 *  howler.js v2.2.3
 *  howlerjs.com
 *
...
(function() {
  ...
  if (typeof commonjsGlobal$1 !== 'undefined') {
    commonjsGlobal$1.HowlerGlobal = HowlerGlobal;
    commonjsGlobal$1.Howler = Howler;
    commonjsGlobal$1.Howl = Howl;
    commonjsGlobal$1.Sound = Sound;
...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock("div", _hoisted_1$4, [
    createVNode("input", {
      ...
      step: "0.1",
      value: "0.5",
      onChange: _cache[1] || (_cache[1] = (...args) => (_ctx.changeVolume && _ctx.changeVolume(...args)))
    }, null, 32),
    createVNode("button", {
      onClick: _cache[2] || (_cache[2] = (...args) => (_ctx.toggleMute && _ctx.toggleMute(...args)))
    }, "Mute/Unmute")
  ]))
}
...
const _hoisted_2$3 = { class: "dialog-container override " };
const _hoisted_3$3 = {
  key: 2,
  class: "flex flex-col"
};
...
function screenToCanvas(x, y, state) {
...
function startApp(config, options) {
    ...
    console.log('%c Narrat game engine – 0.2.12 - July 11, 2021 16:24:29', 'background: #222; color: #bada55');
    app = createApp(script$5, {
        config,
        options,
    });
    app.mount('#app');
